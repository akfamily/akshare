...
| end_date   | str | end_date="20230813"; 开始日期和结束日期之间的间隔要超过 6 个月                                                                                                          |
...
currency_boc_sina_df = ak.currency_boc_sina(symbol="美元", start_date="20230304", end_date="20230813")
...
..          ...     ...     ...        ...     ...
110  2023-08-07  718.00  712.16     720.86  713.80
111  2023-08-08  720.63  714.77     723.51  715.65
112  2023-08-09  719.79  713.94     722.66  715.88
113  2023-08-10  720.74  714.88     723.62  715.76
114  2023-08-11  722.74  716.86     725.62  715.87
...
4     1994-01-06  870.00     NaN  7.7196  ...     NaN      NaN     NaN     NaN
          ...     ...     ...     ...  ...     ...      ...     ...     ...
7232  2023-05-10  692.99  760.04  5.1241  ...  152.46  281.726  256.26  486.16
7233  2023-05-11  691.01  759.11  5.1539  ...  151.95  282.840  253.97  486.68
7234  2023-05-12  694.81  758.50  5.1672  ...  153.55  281.713  253.10  486.78
7235  2023-05-15  696.54  755.83  5.1293  ...  153.29  281.576  252.65  486.68
7236  2023-05-16  695.06  755.93  5.1116  ...  152.39  283.100  251.00  485.79
```
...
描述: 获取指定币种的所有能够获取到的货币对信息，历史数据可以调用 **ak.currency_history()** 获取

限量: 单次返回指定币种的所有能获取数据的货币对; 该接口暂时不能获取数据
