...
```
   期限品种  掉期点(Pips) 掉期点数据源    全价汇率
0    ON      -5.85   报价数据  7.1336
1    TN      -5.92   报价数据  7.1330
2    SN      -5.84   报价数据  7.1319
3    1W     -40.33   报价数据  7.1284
4    2W     -77.78   报价数据  7.1247
5    3W    -142.75   报价数据  7.1182
6    1M    -146.71   报价数据  7.1178
7    2M    -295.50   报价数据  7.1029
8    3M    -433.65   报价数据  7.0891
9    6M    -794.25   报价数据  7.0530
10   9M   -1161.00   报价数据  7.0164
11   1Y   -1486.50   报价数据  6.9838
```
