...
nation_pop_df = ak.macro_china_nbs_nation(
    kind="年度数据", path="人口 > 总人口", period="LAST5"
)
print(nation_pop_df)
```
...
region_gdp_df = ak.macro_china_nbs_region(
    kind="分省季度数据", path="国民经济核算 > 地区生产总值", period="last3", indicator=None, region="河北省"
)
print("region_gdp_df", region_gdp_df, sep='\n')

region_income_df = ak.macro_china_nbs_region(
    "分省季度数据", "人民生活 > 居民人均可支配收入", indicator='居民人均可支配收入_累计值(元)', period="2022"
)
