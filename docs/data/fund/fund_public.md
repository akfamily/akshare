...
接口: fund_scale_change_detail_all_em

目标地址: https://fund.eastmoney.com/data/gmbddetail.html

描述: 天天基金网-基金数据-规模份额-规模变动-基金明细

限量: 单次返回指定季度的所有基金规模明细数据，支持按期末净资产最小值过滤

输入参数

| 名称                  | 类型  | 描述                                                       |
|---------------------|-----|----------------------------------------------------------|
| date                | str | date=""; 季度日期，格式 "YYYY_Q"，如"2026_1"，为空则为当前最新季度            |
| qmjzc_minimum_value | int | qmjzc_minimum_value=0; 期末净资产（亿元）最小值，设置则输出大于该值的基金规模明细，默认输出全部 |
...
| 基金代码       | int  | -         |
| 基金简称       | str  | -         |
| 期间申购（亿份）   | float64 | 注意单位: 亿份  |
| 期间赎回（亿份）   | float64 | 注意单位: 亿份  |
| 期末总份额（亿份）  | float64 | 注意单位: 亿份  |
| 期末净资产（亿元）  | float64 | 注意单位: 亿元  |
...
fund_scale_change_detail_all_em_df = ak.fund_scale_change_detail_all_em(date="2026_1")
print(fund_scale_change_detail_all_em_df)
```

数据示例

```
      基金代码          基金简称  期间申购（亿份）  期间赎回（亿份）  期末总份额（亿份）  期末净资产（亿元）
0      000198       天弘余额宝货币    11607.51    12172.27    7081.52    7081.52
1      000686      建信嘉薪宝货币A     5328.30     5263.08    3966.16    3966.16
2      000359     易方达易理财货币A    10655.40    10658.24    3172.71    3172.71
3      000343      华夏财富宝货币A    10320.02    10063.95    3166.27    3166.27
4      000719        南方现金通E    10902.40    10838.22    2573.62    2573.62
...       ...           ...         ...         ...        ...        ...
25227  007211      汇安中短债债券E         NaN         NaN       0.00       0.00
25228  025642     恒生前海恒裕债券E         NaN        0.00       0.00       0.00
25229  025112  恒生前海港股通价值混合E         NaN        0.40       0.00       0.00
25230  021763        汇添金货币E         NaN         NaN       0.00       0.00
25231  021921       汇泉安阳纯债D         NaN        1.22       0.00       0.00
[25232 rows x 6 columns]
```

#### 单只基金规模变动

接口: fund_scale_single_em

目标地址: https://fundf10.eastmoney.com/gmbd_000001.html

描述: 天天基金网-基金数据-规模份额-单只基金规模变动

限量: 单次返回指定 symbol 的单只基金历史规模变动数据
...
fund_scale_single_em_df = ak.fund_scale_single_em(symbol="000001")
...
0   2026-03-31        1.25        2.44        25.92        26.44   -9.96
1   2025-12-31        0.86        1.77        27.12        29.37   -7.02
2   2025-09-30        1.42        3.32        28.03        31.58   21.50
3   2025-06-30        0.50        0.80        29.93        26.00   -0.16
4   2025-03-31        0.54        0.88        30.23        26.04    3.67
..         ...         ...         ...          ...          ...     ...
93  2002-12-31         NaN         NaN        41.64        39.34   -7.88
94  2002-09-30         NaN         NaN        41.84        42.70   14.22
95  2002-06-30         NaN         NaN        34.85        37.38   14.87
96  2002-03-31         NaN         NaN        31.82        32.54    0.54
97  2001-12-18         NaN         NaN        32.37          NaN     NaN
[98 rows x 6 columns]
```
