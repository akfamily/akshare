...
```
['数据统计截至2020-02-03 19:58', '中国（含港澳台）：确诊 17336 例，死亡 361 例，治愈 497 例', '海外：确诊 153 例，死亡 1 例', '病毒传染源：新型冠状病毒 2019-nCoV', '传播途径：飞沫传播、接触传播、粪口传播']
```
...
| 名称   | 类型 | 必选 | 描述                                                                              |
| -------- | ---- | ---- | --- |
| indicator | str | Y | indicator="历史", 返回历史数据 |
...
```
     date  confirm  suspect  heal  dead  confirm_added
0   01.20      291        0     0     6           93.0
1   01.21      440        0     0     9            NaN
2   01.22      571      393    28    17            NaN
3   01.23      830     1072    34    25            NaN
4   01.24     1287     1965    38    41            NaN
..    ...      ...      ...   ...   ...            ...
9   01.29     7711    12167   124   170            NaN
10  01.30     9689    15238   171   213            NaN
11  01.31    11791    17988   243   259            NaN
12  02.01    14380    19544   328   304            NaN
13  02.02    17205    21558   475   361            NaN
```
...
| 名称   | 类型 | 必选 | 描述                                                                              |
| -------- | ---- | ---- | --- |
| indicator | str | Y | indicator="地区", 返回各地区数据 |
...
```python
import akshare as ak
epidemic_163_df = ak.epidemic_163(indicator="地区")
print(epidemic_163_df)
```
...
```
    name province  confirm  suspect  heal  dead
0     武汉       湖北     2639        0     0   159
1     黄石       湖北      168        0     0     1
2     十堰       湖北      150        0     0     0
3     襄阳       湖北      286        0     0     0
4     宜昌       湖北      167        0     0     1
...
| 名称   | 类型 | 必选 | 描述                                                                              |
| -------- | ---- | ---- | --- |
| indicator | str | Y | indicator="海外", 返回海外数据 |

输出参数-地区

| 名称          | 类型 | 默认显示 | 描述           |
| --------------- | ----- | -------- | ---------------- |
| -      | -   | -        | 此数据最后一行为死亡人数, 格式未处理, 建议用其余接口的数据  |
						
接口示例-地区

```python
import akshare as ak
epidemic_163_df = ak.epidemic_163(indicator="海外")
print(epidemic_163_df)
```
...
```
                         0
0       海外确诊病例：日本20例，泰国19例
1     新加坡18例，韩国15例，澳大利亚12例
2  美国11例，德国10例，马来西亚8例，越南8例
3    法国6例，阿联酋5例，加拿大4例，英国2例
4   意大利2例，俄罗斯2例，菲律宾2例，印度3例
5         芬兰1例，尼泊尔1例，西班牙1例
6        斯里兰卡1例，柬埔寨1例，瑞典1例
7                    菲律宾1例
```
...
| 名称   | 类型 | 必选 | 描述                                                                              |
| -------- | ---- | ---- | --- |
| indicator | str | Y | indicator="全国疫情新增趋势图-湖北", 绘制-全国疫情新增趋势图-湖北|

输出参数-全国疫情新增趋势图-湖北

| 名称          | 类型 | 默认显示 | 描述           |
| --------------- | ----- | -------- | ---------------- |
| 全国疫情新增趋势图-湖北      | pic | Y        |图片, 需要自己保存   |

接口示例-全国疫情新增趋势图-湖北

```python
import akshare as ak
ak.epidemic_dxy(indicator="全国疫情新增趋势图-湖北")
```

图片示例-全国疫情新增趋势图-湖北

![](https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/akshare/readme/event/%E5%85%A8%E5%9B%BD%E7%96%AB%E6%83%85%E6%96%B0%E5%A2%9E%E8%B6%8B%E5%8A%BF%E5%9B%BE-%E6%B9%96%E5%8C%97.png)

输入参数-全国疫情累计趋势图

| 名称   | 类型 | 必选 | 描述                                                                              |
| -------- | ---- | ---- | --- |
| indicator | str | Y | indicator="全国疫情累计趋势图", 绘制-全国疫情累计趋势图|

输出参数-全国疫情累计趋势图

| 名称          | 类型 | 默认显示 | 描述           |
| --------------- | ----- | -------- | ---------------- |
| 全国疫情累计趋势图  | pic | Y        |图片, 需要自己保存   |

接口示例-全国疫情累计趋势图

```python
import akshare as ak
ak.epidemic_dxy(indicator="全国疫情累计趋势图")
```

图片示例-全国疫情累计趋势图

![](https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/akshare/readme/event/%E5%85%A8%E5%9B%BD%E7%96%AB%E6%83%85%E7%B4%AF%E8%AE%A1%E8%B6%8B%E5%8A%BF%E5%9B%BE.png)

输入参数-全国疫情死亡/治愈累计趋势图

| 名称   | 类型 | 必选 | 描述                                                                              |
| -------- | ---- | ---- | --- |
| indicator | str | Y | indicator="全国疫情死亡/治愈累计趋势图", 绘制-全国疫情死亡/治愈累计趋势图|

输出参数-全国疫情死亡/治愈累计趋势图

| 名称          | 类型 | 默认显示 | 描述           |
| --------------- | ----- | -------- | ---------------- |
| 全国疫情死亡/治愈累计趋势图  | pic | Y        |图片, 需要自己保存   |

接口示例-全国疫情死亡/治愈累计趋势图

```python
import akshare as ak
ak.epidemic_dxy(indicator="全国疫情死亡/治愈累计趋势图")
```

图片示例-全国疫情死亡/治愈累计趋势图

![](https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/akshare/readme/event/%E5%85%A8%E5%9B%BD%E7%96%AB%E6%83%85%E6%AD%BB%E4%BA%A1-%E6%B2%BB%E6%84%88%E7%B4%AF%E8%AE%A1%E8%B6%8B%E5%8A%BF%E5%9B%BE.png)

输入参数-全国疫情死亡治愈趋势图

| 名称   | 类型 | 必选 | 描述                                                                              |
| -------- | ---- | ---- | --- |
| indicator | str | Y | indicator="全国疫情死亡治愈趋势图", 绘制-全国疫情死亡治愈趋势图|

输出参数-全国疫情死亡治愈趋势图

| 名称          | 类型 | 默认显示 | 描述           |
| --------------- | ----- | -------- | ---------------- |
| 全国疫情死亡治愈趋势图  | pic | Y        |图片, 需要自己保存   |

接口示例-全国疫情死亡治愈趋势图

```python
import akshare as ak
ak.epidemic_dxy(indicator="全国疫情死亡治愈趋势图")
```

图片示例-全国疫情死亡治愈趋势图

![](https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/akshare/readme/event/%E5%85%A8%E5%9B%BD%E7%96%AB%E6%83%85%E6%AD%BB%E4%BA%A1%E6%B2%BB%E6%84%88%E8%B6%8B%E5%8A%BF%E5%9B%BE.png)
