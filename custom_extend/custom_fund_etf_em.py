...
def _fund_etf_code_id_map_em() -> dict:
    ...
    params = {
        "pn": "1",  # page number - 页码
        "pz": "100",  # page size - 每页数据条数
        "po": "1",  # 排序参数
        "np": "1",  # 未知参数
        "ut": "bd1d9ddb04089700cf9c27f6f7426281",  # 固定token
        "fltt": "2",  # 数据格式
        "invt": "2",  # 投资类型
        "wbp2u": "|0|0|0|web",  # 浏览器标识
        "fid": "f3",  # 排序字段（f3代表涨跌幅）
        "fs": "b:MK0021,b:MK0022,b:MK0023,b:MK0024",  # 市场筛选
        "fields": "f3,f12,f13",  # 返回字段。f12: ETF代码（如"516210"）。f13: 市场标识（1-上海，2-深圳）。f3: 涨跌幅（用于排序）
    }
