    ...
    try:
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            for line in f:
                ...
                # 分割股票代码和后面的列表部分
                # 格式示例：000005.XSHE: [('20160104', '0'), ('20210506', '1')]
...
def data_2_local():
    file_path = "data/code_is_st_change/20160104_20251203/log.txt"
    ...
    for item in parsed_data:
        code = item[0]
        change_list = item[1]
        for (start_date_str, is_st_str) in change_list:
            codes.append(code)
            start_date_strs.append(start_date_str)
            is_sts.append(int(is_st_str))
    ...
    df_append_2_local(table_name='code_is_st_change', df=df)
