...
from data_2_local.etf_tdx_data import get_file_data
...
def update_single_index_data_2_database(code, prefix):
    """
    ...
    try:
        ...
        if last_date:
            ...
            success = fetch_all_data_tdx(code, table_name)
            return success
...
def fetch_all_data_tdx(code, table_name):
    df = get_file_data(code=code)
    if df is None or df.shape[0] == 0:
        print(f"未获取到数据 {code}")
        return False
    success = append_2_table(table_name, df)
...
def fetch_data_tdx(code, table_name, greater_date_ts):
...
def update_middle_small_index_data_2_database():
    ...
    # update_single_index_data_2_database(code='510880', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='159930', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='159928', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='512400', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='515080', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='159985', prefix='etf_qfq_')


    # update_single_index_data_2_database(code='159985', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='518880', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='513100', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='513500', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='512050', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='159949', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='512100', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='588000', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='588100', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='512930', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='513330', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='513090', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='512480', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='510150', prefix='etf_qfq_')
    # update_single_index_data_2_database(code='562500', prefix='etf_qfq_')


if __name__ == '__main__':
    update_middle_small_index_data_2_database()
