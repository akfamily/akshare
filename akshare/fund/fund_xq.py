...
def fund_individual_profit_probability_xq(
    ...
    """
    雪球基金-盈利概率-历史任意时点买入，持有满X年，盈利概率Y%
...
def fund_individual_detail_info_xq(
    symbol: str = "000001", info_type: str = "交易规则", timeout: float = None
) -> pd.DataFrame:
    """
    雪球基金-详细信息
    ...
    :param symbol: 基金代码
    :type symbol: str
    :param info_type: 信息类型，可选“交易规则”或者“持仓资产比例”
    :type symbol: str
    :param timeout: choice of None or a positive float number
    :type timeout: float
    :return: 盈利概率
...
if __name__ == "__main__":
    print(fund_individual_basic_info_xq())
    print(fund_individual_achievement_xq())
    print(fund_individual_analysis_xq())
    print(fund_individual_profit_probability_xq())
    print(fund_individual_detail_info_xq())
    print(fund_individual_detail_info_xq(info_type="持仓资产比例"))
