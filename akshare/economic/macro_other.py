...
def macro_fx_sentiment(start_date="2020-03-27", end_date="2020-03-27"):
    """
    金十数据-外汇-投机情绪报告
...
def index_vix(start_date="2020-02-07", end_date="2020-02-07"):
    """
    金十数据-外汇-投机情绪报告
    外汇投机情绪报告显示当前市场多空仓位比例，数据由8家交易平台提供，涵盖11个主要货币对和1个黄金品种。
    报告内容: 品种: 澳元兑日元、澳元兑美元、欧元兑美元、欧元兑澳元、欧元兑日元、英镑兑美元、英镑兑日元、纽元兑美元、美元兑加元、美元兑瑞郎、美元兑日元以及现货黄金兑美元。
...
if __name__ == "__main__":
    ...
    macro_fx_sentiment_df = macro_fx_sentiment(start_date="2020-03-27", end_date="2020-03-27")
    print(macro_fx_sentiment_df)
    macro_vix_df = index_vix(start_date="2020-03-20", end_date="2020-03-27")
    print(macro_vix_df)
