...
def index_option_50etf_qvix() -> pd.DataFrame:
    ...
    """
    temp_df = _get_optbbs_daily().iloc[:, :5]
    temp_df.columns = [
        "date",
        "open",
        "high",
...
def index_option_300etf_qvix() -> pd.DataFrame:
    ...
    :rtype: pandas.DataFrame
    """
    temp_df = _get_optbbs_daily().iloc[:, [0, 9, 10, 11, 12]]
    temp_df.columns = [
        "date",
        "open",
        "high",
...
def index_option_500etf_qvix() -> pd.DataFrame:
    ...
    :rtype: pandas.DataFrame
    """
    temp_df = _get_optbbs_daily().iloc[:, [0, 67, 68, 69, 70]]
    temp_df.columns = [
        "date",
        "open",
        "high",
...
def index_option_cyb_qvix() -> pd.DataFrame:
    ...
    :rtype: pandas.DataFrame
    """
    temp_df = _get_optbbs_daily().iloc[:, [0, 71, 72, 73, 74]]
    temp_df.columns = [
        "date",
        "open",
        "high",
...
def index_option_kcb_qvix() -> pd.DataFrame:
    ...
    :rtype: pandas.DataFrame
    """
    temp_df = _get_optbbs_daily().iloc[:, [0, 83, 84, 85, 86]]
    temp_df.columns = [
        "date",
        "open",
        "high",
...
def index_option_100etf_qvix() -> pd.DataFrame:
    ...
    :rtype: pandas.DataFrame
    """
    temp_df = _get_optbbs_daily().iloc[:, [0, 75, 76, 77, 78]]
    temp_df.columns = [
        "date",
        "open",
        "high",
...
def index_option_300index_qvix() -> pd.DataFrame:
    ...
    :rtype: pandas.DataFrame
    """
    temp_df = _get_optbbs_daily().iloc[:, [0, 17, 18, 19, 20]]
    temp_df.columns = [
        "date",
        "open",
        "high",
...
def index_option_1000index_qvix() -> pd.DataFrame:
    ...
    :rtype: pandas.DataFrame
    """
    temp_df = _get_optbbs_daily().iloc[:, [0, 25, 26, 27, 28]]
    temp_df.columns = [
        "date",
        "open",
        "high",
...
def index_option_50index_qvix() -> pd.DataFrame:
    ...
    :rtype: pandas.DataFrame
    """
    temp_df = _get_optbbs_daily().iloc[:, [0, 79, 80, 81, 82]]
    temp_df.columns = [
        "date",
        "open",
        "high",
